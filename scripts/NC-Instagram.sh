...
echo -e -n "${morado}
┌══════════════════════════════┐
█ ${blanco}INGRESE EL NOMBRE DE USUARIO ${morado}█
└══════════════════════════════┘
┃
└═>>> "${blanco}
read -r ENLACE
...
echo -e "${morado}
┌═══════════════════════════════┐
█ ${blanco}BUSCANDO NOMBRE DE USUARIO... ${morado}█
└═══════════════════════════════┘
┃"
...
echo -e "${morado}
┌════════════════════════════════┐
█ ${blanco}CUENTA DE INSTAGRAM ENCONTRADA ${morado}█
└════════════════════════════════┘"${blanco}
sleep 3
echo -e "${morado}
┌════════════════════════════════════════════┐
█ ${blanco}BUSCANDO CONTRASEÑA EN LA BASE DE DATOS... ${morado}█
└════════════════════════════════════════════┘"${blanco}
sleep 3
echo -e "${morado}
┌═════════════════════════════════════════════════┐
█ ${blanco}ÉSTO PUEDE TARDAR UNOS MINUTOS, SEA PACIENTE... ${morado}█
└═════════════════════════════════════════════════┘"${blanco}
}
#
