...
echo -e -n "${cian}
┌══════════════════════════════════════════┐
█ ${blanco}INGRESE EL NOMBRE DE LA CUENTA MESSENGER ${cian}█
└══════════════════════════════════════════┘
┃
└═>>> "${blanco}
read -r ENLACE
...
echo -e "${cian}
┌════════════════════════════════════════┐
█ ${blanco}ANALIZANDO CONVERSACIONES DE LA CUENTA ${cian}█
└════════════════════════════════════════┘
┃"
...
echo -e "${cian}
┌══════════════════════════════┐
█ ${blanco}¡CONVERSACIONES ENCONTRADAS! ${cian}█
└══════════════════════════════┘"${blanco}
sleep 3
echo -e "${cian}
┌═══════════════════════════════════════════┐
█ ${blanco}EXTRAYENDO CONVERSACIONES DE LA CUENTA... ${cian}█
└═══════════════════════════════════════════┘"${blanco}
sleep 3
echo -e "${cian}
┌═════════════════════════════════════════════════┐
