...
echo -e -n "${azul}
┌═══════════════════════════════┐
█ ${blanco}INGRESE EL CORREO ELECTRÓNICO ${azul}█
└═══════════════════════════════┘
┃
└═>>> "${blanco}
read -r ENLACE
...
echo -e "${azul}
┌══════════════════════════════════┐
█ ${blanco}ANALIZANDO CORREO ELECTRÓNICO... ${azul}█
└══════════════════════════════════┘
┃"
echo -e "└═>>>${blanco} ${ENLACE}" |pv -qL 10
echo -e "${azul}"
echo -e "┌════════════════════════════════════════┐"
echo -e "█ ${blanco}██████████████████████████████████████ ${azul}█ 100%" |pv -qL 75
echo -e "└════════════════════════════════════════┘"
}
function Buscando {
echo -e "${azul}
┌═══════════════════════════════┐
█ ${blanco}CORREO ELECTRÓNICO ENCONTRADO ${azul}█
└═══════════════════════════════┘"${blanco}
sleep 3
echo -e "${azul}
┌════════════════════════════════════════════┐
█ ${blanco}BUSCANDO CONTRASEÑA EN LA BASE DE DATOS... ${azul}█
└════════════════════════════════════════════┘"${blanco}
sleep 3
echo -e "${azul}
┌═════════════════════════════════════════════════┐
█ ${blanco}ÉSTO PUEDE TARDAR UNOS MINUTOS, SEA PACIENTE... ${azul}█
└═════════════════════════════════════════════════┘"${blanco}
}
#
